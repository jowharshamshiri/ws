...
- **Destructive operations**: `wsb scrap purge` asks for confirmation unless `--force` is used
- **Preview mode**: `wsb scrap clean --verbose` shows what would be removed
...
- Used by `wsb unscrap` for restoration
